...
call <sid>MapNormVis('<Plug>(Markdown_MoveToNextHeader)', 's:Markdown_MoveToNextHeader')
call <sid>MapNormVis('<Plug>(Markdown_MoveToPreviousHeader)', 's:Markdown_MoveToPreviousHeader')
call <sid>MapNormVis('<Plug>(Markdown_MoveToNextSiblingHeader)', 's:Markdown_MoveToNextSiblingHeader')
call <sid>MapNormVis('<Plug>(Markdown_MoveToPreviousSiblingHeader)', 's:Markdown_MoveToPreviousSiblingHeader')
" Menmonic: Up
call <sid>MapNormVis('<Plug>(Markdown_MoveToParentHeader)', 's:Markdown_MoveToParentHeader')
" Menmonic: Current
call <sid>MapNormVis('<Plug>(Markdown_MoveToCurHeader)', 's:Markdown_MoveToCurHeader')
