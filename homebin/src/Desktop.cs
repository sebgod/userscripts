...
namespace Onyeyiri
{
    ...
    /// </summary>
    public class Desktop : Component, ICloneable
    {
        #region Imports
        ...
        enum DesktopAccess : uint
        {
            ...
            AccessRights = JOURNALRECORD | JOURNALPLAYBACK | CREATEWINDOW | ENUMERATE | WRITEOBJECTS | SWITCHDESKTOP | CREATEMENU | HOOKCONTROL | READOBJECTS
        }

        [Flags]
        enum DesktopFlags : uint
        {
        ...
        public Desktop(IContainer container, IntPtr desktop)
        {
            if (container != null)
                container.Add(this);
            // init variables.
            m_desktop = desktop;
            m_desktopName = m_desktop != null ? Desktop.GetDesktopName(m_desktop) : String.Empty;
        ...
        public bool Create(string name)
        {
            ...
            m_desktop = CreateDesktop(name, IntPtr.Zero, IntPtr.Zero, 0, DesktopAccess.AccessRights, IntPtr.Zero);
        ...
        public bool Open(string name)
        {
            ...
            // open the desktop.
            m_desktop = OpenDesktop(name, 0, true, DesktopAccess.AccessRights);
        ...
        public bool OpenInput()
        {
            ...
            // open the desktop.
            m_desktop = OpenInputDesktop(0, true, DesktopAccess.AccessRights);
